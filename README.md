...
- [QAPractices](https://qapractices.com/) - Curated QA resource hub with free test cases, checklists, templates and guides for API, web, mobile, security, accessibility and performance testing.
